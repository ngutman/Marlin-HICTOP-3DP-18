/**
 * REV: 13.09.2016, HICi3-1.1.0-RC7, downloaded from Github archive.
 *
 * A custom configuration.h for HICTOP Reprap Prusa I3 3DP-18
 *
 ...
 * NOTE: to search for actual changes for my HICi3 printer changes here, search for 'Guti:'
 *
 */
...
#define CUSTOM_MACHINE_NAME "HICi3 v1.1RC7" // CL: put version number on LCD menu
